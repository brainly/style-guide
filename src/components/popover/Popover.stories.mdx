...
<Canvas>
  <Story name="Default" parameters={{layout: 'centered'}}>
    {args => (
      <Popover {...args} asLabel>
        <Popover.Element label="Copy to clipboard" />
        <Popover.Trigger>
          <Button
...
<Canvas>
  <Story name="Controlled" parameters={{layout: 'centered'}}>
    {args => {
      ...
      return (
        <Popover {...args} asLabel onOpenChange={setIsOpen} open={isOpen}>
          <Popover.Element label="Copy to clipboard" />
          <Popover.Trigger>
            <Button
              icon={<Icon color="adaptive" type="clipboard" aria-hidden />}
  ...
  <Story name="Types of triggers">
    {args => {
      const RenderPopover = ({trigger}) => (
        <Popover {...args}>
          <Popover.Element label="Here's popover" />
    ...
    {args => {
      const RenderPopover = ({placement}) => (
        <Popover {...args} placement={placement} defaultOpen>
          <Popover.Element label={placement} />
          <Popover.Trigger>
            <Button
            ...
            {['default', 'small'].map(size => (
              ...
              >
                ...
                <Popover {...args} size={size}>
                  <Popover.Element label="Popover content" />
                  <Popover.Trigger>
                    <Button
                      icon={
    ...
    {args => {
      return (
        ...
        >
          ...
          <Popover {...args}>
            <Popover.Element label="Click to see notifications" />
            <Popover.Trigger>
              <Button
                variant="transparent"
                iconOnly
          ...
          <Popover {...args}>
            <Popover.Element label="Go to your profile" />
            <Popover.Trigger>
              <Button
                variant="transparent"
                iconOnly
