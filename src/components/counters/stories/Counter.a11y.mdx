...
| ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
| **Should** have 4.5:1 contrast ratio | `red-60` against white 5.48:1, `blue-60` against white 9.11:1, `gray-20` against black 18.57:1                                                        | Implementation: TO DO<br />Tests: N/A |
