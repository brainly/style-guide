...
const overlayedBoxs = () => <div>
  <DocsBlock info="Icon as button with overlay-box">
    <IconAsButton type={TYPE.MESSAGES}
      overlay={<Badge color={BADGE_COLOR.PEACH} rounded={true}>1</Badge>}/>
    <ContrastBox>
      <IconAsButton color={COLOR.LIGHT} type={TYPE.PROFILE}
        overlay={<Badge color={BADGE_COLOR.MUSTARD} rounded={true}>!</Badge>}/>
    </ContrastBox>
  </DocsBlock>
  ...
  <DocsBlock info="Standard overlay box">
    <ContrastBox>
      ...
      <OverlayedBox overlay={<Badge rounded={true}>1</Badge>}>
        <Avatar/>
      </OverlayedBox>
      <OverlayedBox overlay={<Badge color={BADGE_COLOR.PEACH} rounded={true}>456</Badge>}>
        <Avatar imgSrc="https://source.unsplash.com/64x64/?man"/>
      </OverlayedBox>
    </ContrastBox>
  </DocsBlock>
