...
<Canvas>
  ...
  >
    {args => {
      ...
      const [showSecondOption, setShowSecondOption] = React.useState(true);
      React.useEffect(() => {
      ...
      return (
        <div>
          <Text>The second option will disappear</Text>
          <div style={{width: '200px', marginTop: '10px'}}>
            ...
            >
              <SelectMenu.Option value="history">History</SelectMenu.Option>
              {showSecondOption && (
                <SelectMenu.Option value="math">Math</SelectMenu.Option>
              )}
              <SelectMenu.Option value="science">Science</SelectMenu.Option>
            </SelectMenu.Root>
          </div>
