...
<Canvas>
  <Story name="Default">{args => <SelectMenu {...args} />}</Story>
</Canvas>
        ...
        <Flex direction="column" style={{gap: '20px'}}>
          ...
          <div style={{width: '400px'}}>
            ...
            <SelectMenu
              ...
              placeholder="SelectMenu something from the list"
              selectedOptions={selectedOptions[1]}
              onOptionChange={option => {
                setSelectedOptions({...selectedOptions, 1: [option]});
              }}
      ...
      return (
        <div>
          <Text>
            ...
            SelectMenu position affects the popup position
          </Text>
          <div
            style={{
