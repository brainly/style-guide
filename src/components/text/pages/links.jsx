...
const Links = () =>
  <DocsBlock info="Examples">
    <Text>
      ...
      <div>
        An emphasized link <Link href="#" color={COLOR.GRAY} size={SIZE.SMALL} emphasised={true}>Math</Link><br/>
      </div>
      <div>
        Fine print link <Link href="#" color={COLOR.FINE_PRINT_LIGHT}>brainly.pl</Link><br/>
      </div>
      <div>
        Fine print emphasised link <Link href="#" color={COLOR.FINE_PRINT} emphasised={true}>Terms of use</Link><br/>
      </div>
      <div>
      ...
      <div>
        Some texts and a <Link href="#" underlined={true}>underlined link</Link><br/>
      </div>
      <div>
        Text with <Link href="#" unstyled={true}>unstyled link</Link><br/>
      </div>
      <div>
