...
<Canvas>
  <Story name="test hovers">
    {args => {
      {
        /* console.log(shadowRoot ? shadowRoot.styleSheets : document.styleSheets); */
      }
      return (
        <div>
          <Button variant="solid-indigo">button 1</Button>
          <Button variant="transparent-red">button 2</Button>
        </div>
      );
    }}
  </Story>
