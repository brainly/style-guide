...
describe('Button', () => {
  describe('without `href`', () => {
    it('has a button role and an accessible label', () => {
      ...
      expect(button.getByRole('button', {name: label})).toBeTruthy();
    });
    ...
    it('fires onClick on click, space and enter', () => {
      ...
      userEvent.click(button.getByRole('button', {name: label}));
  ...
  describe('with `href`', () => {
    it('has a link role and an accessible label', () => {
      ...
      expect(button.getByRole('link', {name: label})).toBeTruthy();
