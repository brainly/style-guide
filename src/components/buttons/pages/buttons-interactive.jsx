...
import ButtonPrimary, {BUTTON_TYPE as PRIMARY_TYPE} from '../ButtonPrimary';
import ButtonSecondary, {BUTTON_TYPE as SECONDARY_TYPE} from '../ButtonSecondary';
  ...
  return (
    <div>
      ...
      <DocsActiveBlock settings={secondarySettings} backgroundColor="dark">
        <ButtonSecondary buttonType={SECONDARY_TYPE.INVERSE} small>
          <Label text="Comment" number={21} iconType={ICON_TYPE.COMMENT}
            iconColor={ICON_COLOR.LAVENDER} secondary />
        </ButtonSecondary>
      </DocsActiveBlock>
      <DocsActiveBlock settings={secondarySettings} backgroundColor="dark">
        <ButtonSecondary buttonType={SECONDARY_TYPE.ACTIVE_INVERSE} small>
