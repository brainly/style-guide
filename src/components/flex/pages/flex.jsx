  ...
  <div>
    <DocsBlock info="Spacing utility">
      <Flex direction={FLEX_DIRECTION.COLUMN} marginBottom={FLEX_MARGINS.MEDIUM} fullWidth>
        <Text size={TEXT_SIZE.SMALL}>Use multiples of 8 to define dimensions, padding, and margin of both
          block and inline elements. We add one exeption to the scale which is 4px
          - this is value added to create small padding and margins for little
          components or denser parts of the site. Presented basic setup of
          spacings is used to create other utilities, like margins, paddings or
          icons sizes.
        </Text>
      </Flex>
