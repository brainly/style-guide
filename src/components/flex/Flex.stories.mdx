...
<Meta
  ...
  argTypes={{
    ...
    gap: {
      ...
      table: {
        type: {
          summary: formatTags(Object.values(FLEX_GAP_VALUES)),
        },
      },
      control: {
        type: 'select',
        options: Object.values(FLEX_GAP_VALUES),
      },
    },
    flex: {
      description: '(Responsive)',
      table: {
        type: {
          summary: formatTags(Object.values(FLEX_FLEX_VALUES)),
        },
      },
      control: {
        type: 'select',
        options: Object.values(FLEX_FLEX_VALUES),
      },
    },
  }}
/>
