...
<Canvas>
  <Story name="Margins">
    {args => {
      ...
      const marginTypeLabelBox = {style: {width: '100px'}};
      return (
        <Flex fullWidth direction="column">
          <Flex marginBottom={FLEX_MARGINS.SMALL}>
            <Box {...marginTypeLabelBox}>
              <Text>{FLEX_MARGINS.XSMALL}</Text>
            </Box>
            <Flex marginRight={FLEX_MARGINS.XSMALL}>
          ...
          <Flex
            marginTop={FLEX_MARGINS.SMALL}
            marginBottom={FLEX_MARGINS.SMALL}
          >
            <Box {...marginTypeLabelBox}>
              <Text>{FLEX_MARGINS.SMALL}</Text>
            </Box>
            <Flex marginRight={FLEX_MARGINS.SMALL}>
              <Box {...boxStyle} {...fixedWidthBox} />
            </Flex>
            <Flex>
              <Box {...boxStyle} {...fixedWidthBox} />
          ...
          >
            <Box {...marginTypeLabelBox}>
              <Text>{FLEX_MARGINS.LARGE}</Text>
            </Box>
            <Flex marginRight={FLEX_MARGINS.LARGE}>
              <Box {...boxStyle} {...fixedWidthBox} />
            </Flex>
            <Flex>
              <Box {...boxStyle} {...fixedWidthBox} />
          ...
          >
            <Box {...marginTypeLabelBox}>
              <Text>{FLEX_MARGINS.XLARGE}</Text>
            </Box>
            <Flex marginRight={FLEX_MARGINS.XLARGE}>
              <Box {...boxStyle} {...fixedWidthBox} />
            </Flex>
            <Flex>
              <Box {...boxStyle} {...fixedWidthBox} />
          ...
          >
            <Box {...marginTypeLabelBox}>
              <Text>{FLEX_MARGINS.XXLARGE}</Text>
            </Box>
            <Flex marginRight={FLEX_MARGINS.XXLARGE}>
              <Box {...boxStyle} {...fixedWidthBox} />
            </Flex>
            <Flex>
              <Box {...boxStyle} {...fixedWidthBox} />
          ...
          >
            <Box {...marginTypeLabelBox}>
              <Text>{FLEX_MARGINS.XXXLARGE}</Text>
            </Box>
            <Flex marginRight={FLEX_MARGINS.XXXLARGE}>
              <Box {...boxStyle} {...fixedWidthBox} />
            </Flex>
            <Flex>
              <Box {...boxStyle} {...fixedWidthBox} />
          ...
          >
            <Box {...marginTypeLabelBox}>
              <Text>{FLEX_MARGINS.XXXXLARGE}</Text>
            </Box>
            <Flex marginRight={FLEX_MARGINS.XXXXLARGE}>
              <Box {...boxStyle} {...fixedWidthBox} />
            </Flex>
            <Flex>
              <Box {...boxStyle} {...fixedWidthBox} />
