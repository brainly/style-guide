...
<Row>
  ...
  <Text size="small">
    <Text weight="bold">CSS:</Text>0 2px 8px 0 rgba($grayPrimary, 0.2);
  </Text>
...
<Row>
  ...
  <Text size="small">
    <Text weight="bold">CSS:</Text>0 4px 16px 0 rgba($grayPrimary, 0.2);
  </Text>
...
<Row>
  ...
  <Text size="small">
    <Text weight="bold">CSS:</Text>0 8px 32px 0 rgba($grayPrimary, 0.2);
  </Text>
