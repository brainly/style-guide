...
import TextBit, {TEXT_COLOR} from 'text/TextBit';
...
<Flex direction="column" alignItems="center" className="sg-space-y-s">
  ...
  >
    <Text size="small" weight="bold" color={TEXT_COLOR['text-gray-40']}>
      v{version}
    </Text>
    <TextBit align="center" type="h1" color={TEXT_COLOR['text-black']}>
      Brainly style guide
    </TextBit>
  </Flex>
...
<Flex className="sg-space-x-xs" justifyContent="center">
  ...
  <Text color={TEXT_COLOR['text-gray-40']}>•</Text>
