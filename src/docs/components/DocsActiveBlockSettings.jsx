        ...
        <ActionList>
          <Text size={TEXT_SIZE.SMALL} color={TEXT_COLOR.GRAY}>Code:
            <label className="docs-active-block__label">
              <Radio name={UUID.v1()} checked={!this.props.values.showCode}
                onChange={this.onChangeShowNothing} /> none
            </label>
            <label className="docs-active-block__label">
              <Radio name={UUID.v1()} checked={this.props.values.showCode === 'jsx'}
                onChange={this.onChangeShowJSX} /> JSX
            </label>
            <label className="docs-active-block__label">
              <Radio name={UUID.v1()} checked={this.props.values.showCode === 'html'}
                onChange={this.onChangeShowHTML} /> HTML
            </label>
          </Text>
          <SeparatorVertical />
          <Text size={TEXT_SIZE.SMALL} color={TEXT_COLOR.GRAY}>Background:
            <label className="docs-active-block__label">
              <Radio name={UUID.v1()} checked={!this.props.values.changeBackground}
                onChange={this.onChangeBackgroundDefault} /> none
            </label>
            <label className="docs-active-block__label">
              <Radio name={UUID.v1()} checked={this.props.values.changeBackground === 'light'}
                onChange={this.onChangeBackgroundLight} /> light
            </label>
            <label className="docs-active-block__label">
              <Radio name={UUID.v1()} checked={this.props.values.changeBackground === 'dark'}
                onChange={this.onChangeBackgroundDark} /> dark
            </label>
          </Text>
        </ActionList>
      </div>);
