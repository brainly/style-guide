...
const index = () => (
  <ArticlePage>
    ...
    <p className="sg-text">Welcome to the official Brainly style guide! This style guide is being used across all
      ...
      <a href="https://nosdevoirs.fr/" className="sg-text sg-text--blue-dark sg-text--bold sg-text--link">nosdevoirs.fr</a>
      ), on our
      corporate website (<a href="https://brainly.co" className="sg-text sg-text--blue-dark sg-text--bold sg-text--link">brainly.co</a>) and some smaller sites (e.g.
      landing pages).
    </p>
    ...
    <ul className="sg-list">
      <li className="sg-list__element">
        <ContentBox>
          <ContentBoxHeader>
            <p className="sg-text"><a href="./basics.html#icons" className="sg-text sg-text--blue-dark sg-text--bold sg-text--link">Basic icons</a>:</p>
          </ContentBoxHeader>
          <ContentBoxContent>
            <pre>
              <code className="html">
      ...
      <li className="sg-list__element">
        <ContentBox>
          <ContentBoxHeader>
            <p className="sg-text"><a href="./basics.html#subject-icons" className="sg-text sg-text--blue-dark sg-text--bold sg-text--link">Subject icons</a>:</p>
          </ContentBoxHeader>
          <ContentBoxContent>
            <pre>
              <code className="html">
      ...
      <li className="sg-list__element">
        <ContentBox>
          <ContentBoxHeader>
            <p className="sg-text">
              <a href="./basics.html#subject-mono-icons" className="sg-text sg-text--blue-dark sg-text--bold sg-text--link">Subject mono icons</a>:
            </p>
          </ContentBoxHeader>
          <ContentBoxContent>
            <pre>
      ...
      <li className="sg-list__element">
        <ContentBox>
          <ContentBoxHeader>
            <p className="sg-text"><a href="./basics.html#math-symbols" className="sg-text sg-text--blue-dark sg-text--bold sg-text--link">Math symbols</a>:</p>
          </ContentBoxHeader>
          <ContentBoxContent>
            <pre>
              <code className="html">
    ...
    <p className="sg-text">If you&apos;d like to learn more about this project, report a bug or contribute check it out
      on <a href="https://github.com/brainly/style-guide" className="sg-text sg-text--blue-dark sg-text--bold sg-text--link">GitHub</a>.
    </p>
