...
var LayoutSmall = function LayoutSmall() {
  return React.createElement("html", null, React.createElement("head", null, React.createElement("meta", {
    charSet: "utf-8"
  }), React.createElement("link", {
    rel: "stylesheet",
    href: "../../../style-guide.css"
  })), React.createElement("body", null, React.createElement(Layout, {
    header: header,
    footer: footer
  }, React.createElement(LayoutContent, null, React.createElement(LayoutBox, null, React.createElement(Text, null, "Main content has no padding and no background (both are given by layout box)"))), React.createElement(LayoutAsideContent, null, React.createElement(Text, null, "Aside content has no padding and no background"))), React.createElement("script", {
    src: "images/icons.js"
  })));
};
