...
var LayoutWideThreeColumns = function LayoutWideThreeColumns() {
  return React.createElement("html", null, React.createElement("head", null, React.createElement("meta", {
    ...
    threeColumns: true,
    wide: true
  }, React.createElement(LayoutSecondaryContent, null, React.createElement(Text, null, "Secondary content has no padding and no background")), React.createElement(LayoutContent, null, React.createElement(Text, null, "Main content has no padding and white background")), React.createElement(LayoutAsideContent, null, React.createElement(LayoutBox, null, React.createElement(Text, null, "Aside content has no padding and no background (both are given by layout box)")))), React.createElement("script", {
    src: "images/icons.js"
  })));
};
